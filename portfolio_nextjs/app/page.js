...
export default function Home() {
  ...
  const handleDownload = (language) => {
    const fileName =
      language === "tr" ? "omer_ozturk_tr.pdf" : "omer_ozturk_en.pdf";
  ...
  return (
    <div className="min-h-dvh bg-gradient">
      <div className="w-full flex flex-row items-center rounded-xl pb-5">
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
              <div className="bg-white rounded-lg p-6  max-w-md w-full mx-4">
                <button
                  ...
                  className="float-right bg-slate-950 hover:drop-shadow-lg hover:shadow-white px-2 py-1 rounded-full text-red-500 hover:text-red-700"
                >
