...
const ProjectAdd: React.FC<ProjectAddProps> = ({ project }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (project) {
      await ProjectService.updateProject(project._id, data).then((res) => {
      ...
      await ProjectService.addProject(data).then((res) => {
        console.log(res);
  ...
  return (
    ...
    >
      <div className="flex flex-col">
        <label className="mb-2 text-sm font-medium text-gray-300">Title:</label>
        <input
          type="text"
          name="title"
          value={data.title}
      ...
      <div className="flex flex-col">
        <label className="mb-2 text-sm font-medium text-gray-300">Type:</label>
