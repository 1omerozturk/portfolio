...
const CreateBlogPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-indigo-300 rounded-lg shadow-lg">
      <Link
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <select
              ...
              onChange={handleInputChange}
              className="w-full px-4 py-2 border bg-slate-500 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
              {categories.map((cat) => (
        ...
        <div>
          ...
          <textarea
            ...
            rows={2}
            className="w-full px-4 py-2 border text-black border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={10}
            className="w-full px-4 py-2 border text-black border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none font-mono"
            required
          />
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {formData.tags?.map((tag) => (
              <span
                key={tag}
                className="px-3 py-1 bg-pink-100 text-indigo-700 rounded-full text-sm flex items-center gap-2"
              >
                {tag}
                <button
                  type="button"
        ...
        <div className="flex gap-4 justify-end pt-6 border-t">
          ...
          <button
            type="submit"
            disabled={loading}
            className="px-6 py-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
